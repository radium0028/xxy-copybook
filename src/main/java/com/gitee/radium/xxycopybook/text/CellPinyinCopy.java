 ...
 * @author radium
 */
public class CellPinyinCopy extends AbstractCellTextDecorator {
    public CellPinyinCopy(AbstractCell abstractCell) {
        super(abstractCell);
    }

    public CellPinyinCopy(AbstractCell abstractCell, Color color) {
        super(abstractCell, color);
    }

    public CellPinyinCopy(AbstractCell abstractCell, BasicStroke basicStroke) {
        super(abstractCell, basicStroke);
    }

    public CellPinyinCopy(AbstractCell abstractCell, Color color, BasicStroke basicStroke) {
        super(abstractCell, color, basicStroke);
    }

    public CellPinyinCopy(AbstractCell abstractCell, Font font, Color color) {
